...
import com.example.exchange.Model.Comment;
...
public class CommentAdapter extends RecyclerView.Adapter<CommentAdapter.ViewHolder> {
    ...
    public CommentAdapter(CommentActivity mContext, List<Comment> commentList, String postId) {
    }
        ...
        FirebaseDatabase.getInstance().getReference().child("Users").child(comment.getPublisher()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (user.getImageurl().equals("default")) {
                    ...
                    Picasso.with(mContext).load(user.getImageurl()).into(holder.imageProfile);
                    /*
                    get().load(user.getImageurl()).into(holder.imageProfile);
                     */
                }
            }
